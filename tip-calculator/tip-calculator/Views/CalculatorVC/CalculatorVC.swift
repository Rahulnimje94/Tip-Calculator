...
class CalculatorVC: UIViewController {
    ...
    private func bind() {
        ...
        output.resetCalculatorPublisher.sink { [unowned self] in
            ...
            UIView.animate(withDuration: 0.1, delay: 0, usingSpringWithDamping: 5.0, initialSpringVelocity: 0.5, options: .curveEaseOut) {
    ...
    private func layout() {
        ...
        vStackView.snp.makeConstraints { make in
            ...
            make.bottom.equalTo(view.snp.topMargin).offset(-16)
